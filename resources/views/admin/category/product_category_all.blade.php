...
@section('main')
                    ...
                    <div class="card">
                        <div class="card-body">
                            @can('create_product_category')
                                <a href="{{ route('category.add') }}" class="btn btn-dark waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle">&nbsp;&nbsp;Add Product Category</i></a>
                            @endcan
                            <br><br>
                            <h4 class="card-title"><b>All Product Category</b></h4>
                            <br>
    ...
    <script type="text/javascript">
        var userPermissions = {
            canEditCategory: @can('edit_product_category') true @else false @endcan,
            canDeleteCategory: @can('delete_product_category') true @else false @endcan,
        };
    </script>
